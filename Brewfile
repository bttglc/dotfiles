...
brew "zls"           # Zig LSP server

# ============================================================================
# Zsh Utilities
# ============================================================================

brew "atuin"                   # Magical shell history with search
brew "thefuck"                 # Corrects console command mistakes
...
brew "zsh-syntax-highlighting" # Syntax highlighting for zsh (red/green commands)
...
cask "font-meslo-lg-nerd-font"  # MesloLGS Nerd Font (Powerline symbols, icons)
cask "font-noto-emoji"          # Google Noto Color Emoji font
